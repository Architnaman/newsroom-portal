    ...
    <div style={{
      ...
      <main role="main" style={{ padding: "32px 24px", maxWidth: "860px", margin: "0 auto" }}>
        ...
        <div style={{ marginBottom: "32px" }}>
          ...
          <p style={{ color: t.textMuted, margin: 0, fontSize: "13px" }}>
            Your active assignments and filed reports
          </p>
        </div>

        {loading ? (
          <div style={{ color: t.textMuted, textAlign: "center", padding: "60px", fontSize: "14px" }}>
          ...
          <div>
            ...
            <div style={{ marginBottom: "36px" }}>
              <div style={{ display: "flex", alignItems: "center", gap: "10px", marginBottom: "16px" }}>
                <h2 style={{ color: t.textSecondary, fontSize: "12px", fontWeight: "700", letterSpacing: "1.5px", margin: 0 }}>
                  ACTIVE
                </h2>
                <span style={{
                  padding: "2px 10px",
                  ...
                  {active.map(story => (
                    <div
                      ...
                      style={{
                        ...
                        background: story.is_override && story.override_status === "pending" ? t.dangerBg : t.bgCard,
                        ...
                        <div style={{ flex: 1, minWidth: 0 }}>
                          ...
                          <div style={{ display: "flex", alignItems: "center", gap: "8px", marginBottom: "10px", flexWrap: "wrap" }}>
                            ...
                            <span style={{
                              ...
                              fontSize: "10px",
                              fontWeight: "600",
                              background: `${statusColor[story.status]}15`,
                              color: statusColor[story.status],
                              border: `1px solid ${statusColor[story.status]}30`
                            }}>
                          ...
                          {story.reassign_reason && (
                            <div style={{
                              ...
                              <p style={{ color: t.textMuted, fontSize: "11px", fontWeight: "600", margin: "0 0 4px", letterSpacing: "0.5px" }}>
                                REASSIGNED — EDITOR FEEDBACK
                              </p>
                              <p style={{ color: t.warning, fontSize: "13px", margin: 0, lineHeight: 1.5 }}>
                                {story.reassign_reason}
                              </p>
                            </div>
                          )}
                          ...
                          {story.is_override && story.override_status === "accepted" && (
                            <div style={{
                              ...
                              <p style={{ color: t.success, fontSize: "12px", fontWeight: "600", margin: 0 }}>
                            ...
                            {story.status === "assigned" && (
                              <button
                                ...
                                style={{
                                  ...
                                  fontFamily: "inherit",
                                  whiteSpace: "nowrap",
                                  opacity: updating === story.id ? 0.6 : 1
                                }}>
                  ...
                  {filed.map(story => (
                    <div
                      ...
                      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start" }}>
                        <div style={{ flex: 1 }}>
                          <div style={{
                            color: story.status === "published" ? t.textPrimary : t.textSecondary,
                            fontSize: "15px",
                            fontWeight: "700",
                            marginBottom: "6px"
                          }}>
                          ...
                          {story.editor_feedback && story.status === "published" && (
                            <button
                              onClick={() => setFeedbackModal(story)}
                              style={{
                                padding: "7px 14px",
                                background: t.warningBg,
                                border: `1px solid ${t.warningBorder}`,
      ...
      {overrideModal && (
        <div
          ...
          <div style={{
            background: t.bgCard,
            border: `1px solid ${overrideModal.action === "accept" ? t.successBorder : t.dangerBorder}`,
            borderRadius: "12px",
            width: "100%",
            maxWidth: "460px",
            margin: "24px",
            ...
            <div style={{ display: "flex", justifyContent: "space-between", marginBottom: "8px", alignItems: "center" }}>
              ...
              <button
                onClick={() => { setOverrideModal(null); setOverrideResponse("") }}
                aria-label="Close"
            ...
            <div style={{
              padding: "12px 16px",
              background: overrideModal.action === "accept" ? t.successBg : t.dangerBg,
              border: `1px solid ${overrideModal.action === "accept" ? t.successBorder : t.dangerBorder}`,
              borderRadius: "8px",
              marginBottom: "16px"
            }}>
              <p style={{
                color: overrideModal.action === "accept" ? t.success : t.danger,
                fontSize: "12px",
                margin: 0,
                lineHeight: 1.5,
                fontWeight: "500"
              ...
              <button
                ...
                style={{
                  ...
                  background: overrideResponse.trim()
                    ? (overrideModal.action === "accept" ? t.successBg : t.dangerBg)
                    : t.bgInput,
                  border: `1px solid ${overrideResponse.trim()
                    ? (overrideModal.action === "accept" ? t.successBorder : t.dangerBorder)
                    : t.borderCard}`,
                  borderRadius: "8px",
                  color: overrideResponse.trim()
                    ? (overrideModal.action === "accept" ? t.success : t.danger)
                    : t.textDisabled,
                  fontSize: "13px",
                  fontWeight: "700",
        ...
        <div
          ...
          <div style={{
            ...
            <div style={{ display: "flex", justifyContent: "space-between", marginBottom: "8px", alignItems: "center" }}>
              ...
              <button
                onClick={() => { setFileModal(null); setSelectedFile(null) }}
                aria-label="Close"
                style={{ background: "none", border: "none", color: t.textMuted, fontSize: "22px", cursor: "pointer" }}>
                x
              </button>
            ...
            <div
              role="button"
              aria-label="Click to select Word document"
              tabIndex={0}
              onClick={() => document.getElementById("file-input")?.click()}
              onKeyDown={e => e.key === "Enter" && document.getElementById("file-input")?.click()}
              style={{
                border: `2px dashed ${selectedFile ? "rgba(167,139,250,0.6)" : t.borderCard}`,
                borderRadius: "10px",
                padding: "32px 20px",
                textAlign: "center",
                cursor: "pointer",
                marginBottom: "20px",
                background: selectedFile ? "rgba(167,139,250,0.06)" : t.bgInput,
                transition: "all 0.15s"
              }}>
              {selectedFile ? (
                <div>
                  <div style={{ fontSize: "40px", marginBottom: "10px" }}>📘</div>
                  <p style={{ color: "#a78bfa", fontSize: "14px", fontWeight: "600", margin: "0 0 4px" }}>
                    {selectedFile.name}
                  </p>
                ...
                <div>
                  <div style={{ fontSize: "40px", marginBottom: "10px" }}>📘</div>
                  <p style={{ color: t.textSecondary, fontSize: "14px", fontWeight: "600", margin: "0 0 6px" }}>
            ...
            <div style={{ display: "flex", gap: "8px" }}>
              ...
              <button
                onClick={uploadAndFile}
                disabled={!selectedFile || uploadingId === fileModal.id}
                style={{
                  flex: 1, padding: "12px",
                  background: selectedFile ? "rgba(167,139,250,0.15)" : t.bgInput,
                  border: `1px solid ${selectedFile ? "rgba(167,139,250,0.4)" : t.borderCard}`,
                  borderRadius: "8px",
                  color: selectedFile ? "#a78bfa" : t.textDisabled,
                  fontSize: "13px",
                  fontWeight: "700",
                  cursor: selectedFile ? "pointer" : "not-allowed",
                  fontFamily: "inherit",
                  opacity: uploadingId === fileModal.id ? 0.6 : 1
                }}>
        ...
        <div
          ...
          <div style={{
            ...
            <div style={{
              ...
              <p style={{ color: t.textMuted, fontSize: "11px", fontWeight: "600", letterSpacing: "0.5px", margin: "0 0 10px" }}>
                EDITOR SAYS
              </p>
              <p style={{ color: t.warning, fontSize: "15px", fontWeight: "600", margin: 0, lineHeight: 1.6 }}>
                {feedbackModal.editor_feedback}
              </p>
              {feedbackModal.feedback_at && (
                <p style={{ color: t.textMuted, fontSize: "11px", margin: "8px 0 0" }}>
                  {new Date(feedbackModal.feedback_at).toLocaleString()}
                </p>
              )}
            </div>
