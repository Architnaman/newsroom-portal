      ...
      <main role="main" style={{ padding: '32px 24px', maxWidth: '760px', margin: '0 auto' }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '20px' }}>
          ...
          <SectionCard
            ...
            {/* Legend */}
            <div style={{ display: 'flex', gap: '12px', marginBottom: '20px', flexWrap: 'wrap', padding: '10px 14px', background: t.bgPage, borderRadius: '8px', border: `1px solid ${t.borderCard}` }}>
              {[
              ...
              {DAYS.map(day => {
                ...
                return (
                  <button key={day} onClick={() => toggleDay(day)}
                    ...
                    <div style={{ fontSize: '10px', fontWeight: '700', marginBottom: '6px', color: 'inherit', letterSpacing: '0.5px' }}>{day}</div>
                    <div style={{ width: '10px', height: '10px', borderRadius: '50%', margin: '0 auto 4px', background: getDotColor(status) }} />
                    <div style={{ fontSize: '8px', letterSpacing: '0.5px', minHeight: '10px', fontWeight: '700', color: 'inherit' }}>{getDayLabel(status)}</div>
                  </button>
                )
              })}
            </div>
          ...
          <SectionCard
            ...
            <div style={{ display: 'flex', justifyContent: 'flex-end', marginBottom: '16px' }}>
              <button onClick={() => setShowLeave(true)}
                style={{ padding: '9px 20px', background: t.accentBg, border: `1px solid ${t.accentBorder}`, borderRadius: '8px', color: t.accent, fontSize: '12px', fontWeight: '700', cursor: 'pointer', fontFamily: 'inherit' }}>
                + FILE LEAVE
              </button>
            </div>
            {leaves.length === 0 ? (
                      ...
                      <div style={{ flex: 1 }}>
                        <div style={{ display: 'flex', alignItems: 'center', gap: '10px', marginBottom: '6px', flexWrap: 'wrap' }}>
                          ...
                          {isPast(leave.leave_date) && leave.status === 'acknowledged' && (
                            <span style={{ padding: '3px 8px', borderRadius: '4px', fontSize: '10px', fontWeight: '600', background: t.bgInput, color: t.textMuted, border: `1px solid ${t.borderCard}` }}>
                              COMPLETED
                            </span>
                          )}
                        </div>
          ...
          <SectionCard
            ...
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '16px' }}>
              ...
              <button onClick={() => setShowRequestFiling(true)}
                style={{ padding: '9px 20px', background: t.warningBg, border: `1px solid ${t.warningBorder}`, borderRadius: '8px', color: t.warning, fontSize: '12px', fontWeight: '700', cursor: 'pointer', fontFamily: 'inherit', whiteSpace: 'nowrap', marginLeft: '12px' }}>
                + REQUEST
              </button>
            </div>
