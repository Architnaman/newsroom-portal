...
export default function AvailabilityPage() {
  ...
  async function submitFilingRequest() {
    ...
    await supabase.from('leave_filing_requests').insert({
      reporter_id: reporterId,
    ...
    <div style={{
                ...
                <div
                  ...
                  <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start' }}>
                    <div style={{ flex: 1 }}>
                      <div style={{ display: 'flex', alignItems: 'center', gap: '10px', marginBottom: '6px', flexWrap: 'wrap' }}>
                        <span style={{
                          ...
                          fontWeight: '700',
                          letterSpacing: '0.5px',
                          background: `${ltc[leave.leave_type]}15`,
                          color: ltc[leave.leave_type],
                    ...
                    <span style={{
                      ...
                      fontWeight: '700',
                      letterSpacing: '0.5px',
                      background: `${lsc[leave.status]}15`,
                      color: lsc[leave.status],
                    ...
                    <div>
                      <div style={{ display: 'flex', alignItems: 'center', gap: '10px', marginBottom: '6px' }}>
                        ...
                        <span style={{
                          ...
                          fontSize: '10px',
                          fontWeight: '600',
                          background: `${ltc[req.leave_type]}15`,
                          color: ltc[req.leave_type],
        ...
        <div
          ...
          <div style={{
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
                  ...
                  {(['planned', 'sick', 'emergency'] as const).map(type => (
                    <button
                      ...
                      style={{
                        ...
                        fontSize: '11px',
                        fontWeight: leaveForm.leave_type === type ? '700' : '400',
                        letterSpacing: '0.5px',
                        cursor: 'pointer',
                        fontFamily: 'inherit',
              ...
              <button
                onClick={submitLeave}
                disabled={submittingLeave || !leaveForm.leave_date}
                style={{
                  padding: '14px',
                  background: leaveForm.leave_date ? t.accent : t.textMuted,
                  border: 'none',
                  borderRadius: '8px',
                  color: t.accentText,
                  fontSize: '13px',
                  ...
                  fontFamily: 'inherit',
                  opacity: submittingLeave || !leaveForm.leave_date ? 0.6 : 1
                }}>
      ...
      {showRequestFiling && (
        <div
          role="dialog"
          aria-modal="true"
          aria-label="Request editor to file leave"
          style={{
            position: 'fixed', inset: 0,
            background: t.overlayBg,
            display: 'flex', alignItems: 'center', justifyContent: 'center',
          ...
          <div style={{
            ...
            <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: '16px', alignItems: 'center' }}>
              ...
              <button
                onClick={() => setShowRequestFiling(false)}
                aria-label="Close"
                style={{ background: 'none', border: 'none', color: t.textMuted, fontSize: '22px', cursor: 'pointer' }}>
                x
              </button>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
              <div>
                ...
                <input
                  type="date"
                  value={filingForm.requested_date}
                  min={today}
              ...
              <div>
                ...
                <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3,1fr)', gap: '8px' }} role="group">
                  {(['planned', 'sick', 'emergency'] as const).map(type => (
                    <button
                      key={type}
                      aria-pressed={filingForm.leave_type === type}
                      ...
                      style={{
                        ...
                        fontSize: '11px',
                        fontWeight: filingForm.leave_type === type ? '700' : '400',
                        cursor: 'pointer',
                        fontFamily: 'inherit',
                        textTransform: 'uppercase' as const,
                        transition: 'all 0.15s'
              ...
              <div>
                ...
                <textarea
                  value={filingForm.reason}
                  onChange={e => setFilingForm(p => ({ ...p, reason: e.target.value }))}
                  rows={3}
                  placeholder="Why do you need the editor to file this leave..."
                  style={{ ...inputStyle, resize: 'none' as const }}
                />
              </div>
              <div style={{ display: 'flex', gap: '8px' }}>
                ...
                <button
                  ...
                  style={{
                    ...
                    fontFamily: 'inherit',
                    opacity: submittingFiling ? 0.6 : 1
                  }}>
