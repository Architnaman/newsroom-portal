...
-- Reset reporters beats properly
UPDATE reporters SET beats = ARRAY['Politics','Economy'] WHERE email = 'priya@newsroom.com';
UPDATE reporters SET beats = ARRAY['Tech','Science'] WHERE email = 'arjun@newsroom.com';
UPDATE reporters SET beats = ARRAY['Crime','Local'] WHERE email = 'fatima@newsroom.com';
UPDATE reporters SET beats = ARRAY['Sports','Entertainment'] WHERE email = 'ravi@newsroom.com';
UPDATE reporters SET beats = ARRAY['Business','Economy'] WHERE email = 'sunita@newsroom.com';
